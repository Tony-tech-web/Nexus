      ...
      >
        ...
        >
          ...
          <h1 className="text-5xl font-extrabold text-white tracking-tight mb-4 leading-tight">
            Build Your <br /><span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-indigo-400">Enterprise</span> Legacy
          </h1>
          <p className="text-slate-400 text-lg max-w-md mx-auto leading-relaxed">
            Join the elite circle of infrastructure managers. Scalability, security, and precision, all in one place.
          </p>
          ...
          <div className="mt-16 grid grid-cols-2 gap-4 w-full max-w-sm">
            ...
            <div className="bg-slate-800/50 backdrop-blur-md border border-slate-700/50 p-4 rounded-2xl flex items-center gap-3">
              ...
              <div className="text-left">
                <p className="text-white text-xs font-bold">Privacy</p>
                <p className="text-slate-500 text-[10px]">By Design</p>
              </div>
            </div>
          </div>
        </motion.div>
      ...
      >
        <div className="w-full max-w-md">
          ...
          <div className="mb-10 text-center lg:text-left">
            ...
            <p className="text-slate-400">Register your organization for a Nexus account.</p>
          </div>

          <div className="space-y-6">
            {error && (
              <div className="bg-rose-500/10 border border-rose-500/20 text-rose-500 text-sm py-4 px-5 rounded-2xl flex items-center gap-3 transition-opacity">
            ...
            <form onSubmit={handleSignup} className="space-y-5">
              ...
              <div className="space-y-2">
                <label className="text-[11px] font-bold uppercase tracking-[0.2em] text-slate-500 ml-1">Password</label>
                <div className="relative group">
              ...
              <div className="space-y-2">
                <label className="text-[11px] font-bold uppercase tracking-[0.2em] text-slate-500 ml-1">Confirm Password</label>
                <div className="relative group">
                  <Lock className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-500 group-focus-within:text-blue-500 transition-colors" />
                  <input 
                    type="password" 
              ...
              >
                ...
                {loading ? (
                  ...
                  <>
                    <span>Initialize Enterprise Account</span>
            ...
            <div className="relative py-4 flex items-center gap-4">
              ...
              <span className="text-[10px] uppercase font-bold text-slate-600 tracking-widest whitespace-nowrap px-2">Secure Social Register</span>
              <div className="h-[1px] flex-1 bg-slate-800"></div>
            </div>
